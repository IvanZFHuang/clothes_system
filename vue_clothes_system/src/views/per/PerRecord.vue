  ...
  <div>
    <div style="display: flex;justify-content: space-between">
      <div>
        <el-input
          ...
          @clear="listRecord"
          v-model="keyWord"
          @keydown.enter.native="listRecord"
    ...
    <div style="margin-top:10px">
      ...
      >
        ...
        <el-table-column prop="recordTime" label="消费时间" width="180px"></el-table-column>
        <el-table-column prop="member.balance" label="会员余额" width="100px"></el-table-column>
        <el-table-column prop="recordDetail" label="消费详情"></el-table-column>
      </el-table>
    </div>
    <!-- 分页的组件 -->
...
export default {
  ...
  methods: {
    ...
    listRecord() {
      ...
      let url =
        "/record/basic/listRecord?pageNum=" +
        this.pageNum +
        "&pageSize=" +
        this.pageSize;
